...
from simple_transformer import SimpleTransformerXRayEnhancer
...
def train_simple_transformer():
    ...
    print("Starting Simple Transformer Training...")
    ...
    # Save final model
    torch.save(model.state_dict(), 'final_simple_transformer.pth')
    ...
    plt.title('Simple Transformer Training Progress')
    plt.xlabel('Epoch')
    plt.ylabel('Loss')
    plt.legend()
    plt.grid(True)
    plt.savefig('simple_transformer_training.png')
    plt.show()
...
if __name__ == '__main__':
    model, train_losses, val_losses = train_simple_transformer()
