...
class MedicalXRayEnhancer(nn.Module):
    def __init__(self):
        super(MedicalXRayEnhancer, self).__init__()
    ...
    def forward(self, x):
        ...
        encoded_flat = encoded.view(b, h*w, c)
...
def train_model():
    print("🏥 Training Medical X-Ray Enhancement Model")
    print("=" * 50)
    ...
    # Load dataset
    (train_paths, train_labels), (val_paths, val_labels) = load_dataset(dataset_path)
    ...
    # Model
    model = MedicalXRayEnhancer().to(device)
